...
//---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
                       OSM(MOD_RCTL), OSM(MOD_LSFT),                                                          KC_SPACE, TO(1)
//---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
),

[1] = LAYOUT(
//---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
KC_ESCAPE, KC_AT, LSFT(KC_3), TD(DANCE_31), KC_PERC,                                        KC_CIRC, KC_AMPR, KC_ASTR, KC_GRV,  KC_BSPC,
//----------------------------------------------------------------------------       ----------------------------------------------------------------------------------
KC_TAB, KC_LBRC, KC_LPRN, KC_RPRN, KC_RBRC,                                              KC_QUOT, KC_SCOLON, LSG(KC_O), LGUI(KC_P), KC_ENTER,
//----------------------------------------------------------------------------       ----------------------------------------------------------------------------------
TD(BKSL_HME), LGUI(KC_GRV), LGUI(KC_L), LGUI(KC_S), TD(PIPE_END),                                 KC_EQL, RALT(KC_3), LGUI(KC_C), LGUI(KC_V), KC_LALT,
//---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
TO(0), OSM(MOD_LSFT),                                                                      KC_LGUI, TO(2)
//---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
),
...
//---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
	     KC_TAB, KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT,                                        LCA(KC_ENTER), LCA(KC_C), LCA(KC_LEFT), LCA(KC_RIGHT), KC_ENTER,
//---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
	     LGUI(KC_COMMA), LGUI(LCTL(KC_Q)), LSG(KC_LBRC), LSG(KC_RBRC),  KC_LALT,              KC_TRNS, OSM(MOD_RALT), KC_TRNS, KC_TRNS,  MOD_RCTL,
//---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
              TO(0), KC_LGUI,                                                                  KC_RSFT, TO(3)
//---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
),
...
[3] = LAYOUT(
//---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
	     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                        KC_TRNS, KC_MUTE, KC_AUDIO_VOL_DOWN, KC_AUDIO_VOL_UP, KC_BSPC,
//---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
	     KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,                                                  KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,
//---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
KC_TRNS, KC_TRNS, KC_TRNS, KC_F11, KC_TRNS,                                                     KC_TRNS, KC_F12, KC_TRNS, KC_TRNS, KC_TRNS,
//---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
